...
function App() {
  return (
    <div className="App flex flex-col min-h-screen bg-black text-green-400 font-mono">
      ...
      <footer className="p-4 bg-gray-900 border-t-2 border-green-500 text-center">
        <p className="flex items-center justify-center text-yellow-400">
          ...
          Disclaimer: In true beauracratic style, this system is about as reliable as a chocolate teapot. Use at your own risk!
        </p>
      </footer>
    </div>
  );
